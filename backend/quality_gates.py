...
class QualityDimension(Enum):
    """The 8 dimensions every build must score 99%+ on"""
    COMPLETENESS = "completeness"     # All requirements addressed (1.5x weight)
    COHERENCE = "coherence"           # Internal consistency (1.3x weight)
    CORRECTNESS = "correctness"       # Functional accuracy (1.5x weight)
    SECURITY = "security"             # Vulnerability assessment (1.4x weight)
    PERFORMANCE = "performance"       # Efficiency metrics (1.0x weight)
    SCALABILITY = "scalability"       # Growth capacity (1.0x weight)
    MAINTAINABILITY = "maintainability"  # Code quality (1.1x weight)
    COMPLIANCE = "compliance"         # Regulatory adherence (1.2x weight)
